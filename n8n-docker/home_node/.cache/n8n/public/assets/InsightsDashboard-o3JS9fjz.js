const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-Z4Y0nO-i.js","assets/index-BpdkKRP4.js","assets/index-C5OXOcIJ.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-CaKTe2mv.js","assets/chartjs.utils-BcXTJ2Te.js","assets/InsightsSummary-DzYli0Pu.js","assets/InsightsSummary-FixbpmPJ.css","assets/index-7WdERzqm.js","assets/InsightsChartFailed-TYjH8LwV.js","assets/InsightsChartFailureRate-D41Jv-6v.js","assets/InsightsChartTimeSaved-TLPDAmPx.js","assets/InsightsChartAverageRuntime-SeBUN06R.js","assets/InsightsTableWorkflows-CUHAG57c.js","assets/InsightsTableWorkflows-Blv_GPUj.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, gV as useInsightsStore, q as computed, b_ as defineAsyncComponent, r as ref, I as watch, h as resolveComponent, i as createElementBlock, g as openBlock, k as createBaseVNode, j as createVNode, w as withCtx, l as createTextVNode, t as toDisplayString, m as unref, c as useI18n, e as createBlock, f as createCommentVNode, n as normalizeClass, b6 as resolveDynamicComponent, aq as __vitePreload, _ as _export_sfc } from "./index-BpdkKRP4.js";
import { I as InsightsSummary } from "./InsightsSummary-DzYli0Pu.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-Z4Y0nO-i.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-CaKTe2mv.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-TYjH8LwV.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-D41Jv-6v.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-TLPDAmPx.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-SeBUN06R.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-CUHAG57c.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
